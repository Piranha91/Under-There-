...
namespace UnderThere.Settings
{
    public class UTconfig
    {
        ...
        #region Defaults
        {
            { Quality.Poor, new HashSet<FormLink<IClassGetter>>()
            {
            ...
            { Quality.Medium, new HashSet<FormLink<IClassGetter>>()
            {
        ...
        #region Defaults
        {
            { Quality.Poor, new HashSet<FormLink<IFactionGetter>>()
            {
            ...
            { Quality.Medium, new HashSet<FormLink<IFactionGetter>>()
            {
            ...
            { Quality.Rich, new HashSet<FormLink<IFactionGetter>>()
            {
